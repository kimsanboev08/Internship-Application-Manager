...
-- Review_P23
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100003, 109, '2021-05-15', '2021-08-05', 4.0, 'Teamwork will be crucial.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100009, 101, '2021-06-05', '2021-07-28', 3.5, 'Don''t rely on basics.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100014, 103, '2021-06-01', '2021-08-13', 3.0, 'Python will be used heavily.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100007, 110, '2021-05-25', '2021-07-28', 4.0, 'Make sure you memorize the COT formulas.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100001, 101, '2021-06-08', '2021-07-30', 5.0, 'Do exta work outside internship hours.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100014, 105, '2021-05-12', '2021-07-30', 4.5, 'Never argue with your assigned mentor.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100001, 107, '2021-06-01', '2021-08-21', 2.0, 'Don''t apply, you will just waste your Summer.');
INSERT INTO Review_P23 (StudentID, PositionID, Start_of_term, End_of_term, Rating, Feedback) VALUES(100008, 104, '2021-05-13', '2021-08-15', 3.0, 'Low pay.');

UPDATE Review_P23 SET Start_of_term = DATE_FORMAT(Start_of_term, '%M %d, %Y');
UPDATE Review_P23 SET End_of_term = DATE_FORMAT(End_of_term, '%M %d, %Y');
...
-- ALTER TABLE ProjectSchool AUTO_INCREMENT = 1000;

-- INSERT INTO ProjectSchool(DepartmentName, StudentNumber, MinimumPercentage, MinimumAccepted) VALUES('Accounting', 55, 40.00, StudentNumber * (MinimumPercentage / 100));
-- INSERT INTO ProjectSchool(DepartmentName, StudentNumber, MinimumPercentage) VALUES("Chemical Engineering", 62, 30.00);
-- INSERT INTO ProjectSchool(DepartmentName, StudentNumber, MinimumPercentage) VALUES("Civil Engineering", 57, 30.00);


-- INSERT INTO ProjectSchool(MinimumAccepted) VALUES((SELECT StudentNumber FROM ProjectSchool WHERE DepartmentID = 1000) * ((SELECT MinimumAccepted FROM ProjectSchool WHERE DepartmentID = 1000)/ 100));